...
cosmos_predict2_2b_480p_robocasa_50_demos_per_task__resumeFrom50K_648_rollouts_Vsprime_value_func = LazyDict(
    dict(
        ...
        checkpoint=dict(
            ...
            load_path="/work/02/gb20/b20080/Workspace/when2plan/cosmos-policy/.imaginaire_output/cosmos_policy/cosmos_v2_finetune/cosmos_predict2_2b_480p_robocasa_50_demos_per_task__resumeFrom50K_648_rollouts_Vsprime_value_func/checkpoints/iter_000006000",
